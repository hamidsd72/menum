...
class ProfileController extends Controller
{
    ...
    public function show()
    {
        ...
        $url = url('/').'/'.'store/'.$restaurant->slug.'/'.auth()->user()->id;
        return view('admin.profile.show',compact('item','restaurant','url'),['title1'=> $this->controller_title('single') ,'title2' => $this->controller_title('sum')]);
    }
    public function edit()
    {
        ...
        return view('admin.profile.profile_edit',compact('item','states','citys'),['title1'=>'داشبورد','title2' => 'ویرایش پروفایل']);
    }
    public function password_edit()
    {
        $item=User::find(Auth::user()->id);
        return view('admin.profile.password_edit',compact('item'),['title1'=>'داشبورد','title2' => 'ویرایش رمز عبور']);
    }
