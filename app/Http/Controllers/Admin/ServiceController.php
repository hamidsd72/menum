...
class ServiceController extends Controller
{
    ...
    public function index(Request $request) 
    {
        ...
        if(isset($category_id)){
            ...
            $items = Service::where('category_id','!=',4)->orderByDesc('id')->paginate(50);
        }
        $ServiceCats = ServiceCat::where('type','service')->where('id','!=',4)->get();
    ...
    public function create()
    {
        ...
        $cat   = Category::all();
        return view('admin.service.create',compact('items','cat'), ['title1' => $this->controller_title('single'), 'title2' => $this->controller_title('sum')]);
    }
...
//            }
    ...
    public function edit($id)
    {
        ...
        $cat   = Category::all();
        return view('admin.service.edit', compact('items','item','cat'), ['title1' => $this->controller_title('single'), 'title2' => $this->controller_title('sum')]);
    }
