                    ...
                    <div class="col-12">
                        <div class="card res_table">
                            <div class="card-header">
                                ...
                                <a href="{{route('admin.service.category.create')}}" class="float-left btn btn-primary"><i class="fa fa-circle-o mtp-1 ml-1"></i>افزودن</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body res_table_in">
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td class="@if ($item->slug == "اشتراک ندارد") text-danger @else text-success @endif">
                                            @item($item->slug)
                                        </td>
