<head>
    ...
    <title>{{$restaurant->title ?? 'اپلیکیشن منوم'}}</title>
    <link rel="icon" type="image/png" sizes="96x96" href="{{ asset('assets/images/menum-orange.jpeg') }}">
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/images/menum-orange.jpeg') }}">
